...
const OFFICIAL_MODELS: Array<[string, string, number]> = [
  ...
  ["deepseek/deepseek-v4.1-flash", "DeepSeek V4.1 Flash", 1000000],
  ...
  ["Qwen/Qwen3.8-Omni-Flash", "Qwen 3.8 Omni Flash", 1000000],
  ["z-ai/glm-5.3-flash", "GLM-5.3 Flash", 1048576],
  ["z-ai/glm-5.3-flashx", "GLM-5.3 FlashX", 1000000],
  ...
  ["stepfun/Step-5-Preview", "Step 5 Preview", 1000000],
  ["tencent/hy4-preview", "Tencent Hy4 Preview", 1048576],
  ["xiaomi/mimo-v2.6-pro", "MiMo V2.6 Pro", 1048576],
  ["xiaomi/mimo-v2.6-pro-ultraspeed", "MiMo V2.6 Pro UltraSpeed", 1048576],
...
const PROTOCOL_MAP = new Map<string, "openai" | "anthropic">([
  ...
  ["deepseek/deepseek-v4.1-flash", "openai"],
  ...
  ["Qwen/Qwen3.8-Omni-Flash", "openai"],
  ["z-ai/glm-5.3-flash", "openai"],
  ["z-ai/glm-5.3-flashx", "openai"],
  ...
  ["stepfun/Step-5-Preview", "openai"],
  ["tencent/hy4-preview", "openai"],
  ["xiaomi/mimo-v2.6-pro", "openai"],
  ["xiaomi/mimo-v2.6-pro-ultraspeed", "openai"],
